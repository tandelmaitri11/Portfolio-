          ...
          <div className="bg-white dark:bg-[#2A211B] rounded-[2rem] p-8 md:p-10 border border-stone-200 dark:border-[#3f3129] shadow-lg shadow-stone-200/50 dark:shadow-black">
            <form ref={form} onSubmit={sendEmail} className="space-y-6">
              <div>
                ...
                <input type="text" name="from_name" required placeholder="John Doe" className="w-full bg-stone-50 dark:bg-[#1B1612] border border-stone-200 dark:border-[#3f3129] text-[#4A3528] dark:text-white rounded-xl px-5 py-4 outline-none focus:border-amber-800 dark:focus:border-amber-500 transition" />
              </div>
              <div>
                <label className="text-[#4A3528] dark:text-[#F4E7D4] font-bold block mb-2 text-sm">Email Address</label>
                <input type="email" name="from_email" required placeholder="john@example.com" className="w-full bg-stone-50 dark:bg-[#1B1612] border border-stone-200 dark:border-[#3f3129] text-[#4A3528] dark:text-white rounded-xl px-5 py-4 outline-none focus:border-amber-800 dark:focus:border-amber-500 transition" />
              </div>
              <div>
